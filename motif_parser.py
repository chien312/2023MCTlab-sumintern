...
import sys
sys.path.insert(1, r'/Users/chien/Desktop/SuLi/pattern discovery/motif_code_and_data/repeated_pattern_discovery-master')
...
csv_note_dir = r'/Users/chien/Desktop/SuLi/pattern discovery/motif_code_and_data/Beethoven_motif-main/csv_notes'
csv_label_dir = r'/Users/chien/Desktop/SuLi/pattern discovery/motif_code_and_data/Beethoven_motif-main/csv_label'
motif_midi_dir = r'/Users/chien/Desktop/SuLi/pattern discovery/motif_code_and_data/Beethoven_motif-main/motif_midi'
# motif_midi_dir = r'/Users/chien/Desktop/SuLi/pattern discovery/motif_code_and_data/Beethoven_motif-main/motif_midi'
# /Users/chien/Desktop/SuLi/pattern discovery/motif_code_and_data/Beethoven_motif-main
'''Directory of the experiment dataset'''
'''@experiment_datasets'''
baseline_note_dir = r'Users/chien/Desktop/SuLi/pattern discovery/motif_code_and_data/Beethoven_motif-main/experiment_datasets/TsungPings_test_motif_dataset'

'''directory of the JKUPDD dataset'''
jkupdd_data_dir = r'C:Users/chien/Desktop/SuLi/pattern discovery/motif_code_and_data/JKUPDD/JKUPDD-noAudio-Aug2013/groundTruth'
...
def load_all_notes(filename):
    ...
    with open(filename, 'r') as f:
        ...
        # for row in reader:
        #     try:
        #         # np.array(tuple(row), dtype=dt)
        #         np.array(tuple([x for i, x in enumerate(row) if i != 2]), dtype=dt)
        #     except:
        #         print(row)
        #         exit(1)
        notes = np.array([tuple([x for i, x in enumerate(row) if i != 2]) for row in reader], dtype=dt)
    # print('number of notes =', notes.size)

    # Get unique notes irrespective of 'staffNum'
    # _, unique_indices = np.unique(notes[['onset', 'pitch', 'mPitch']], return_index=True)
...
def main():
    ...
    for i in range(1,33):
        ...
        # patterns_est = [[pattern1_occ1, pattern1_occ2 ...], [pattern2_occ1, pattern2_occ2 ...]...]
